    ...
    <>
      <div className="relative px-6 py-24 lg:py-8 lg:px-36 lg:py-24 lg:pb-96 flex flex-col items-center justify-center">
        <h1 className="font-semibold text-4xl break-words max-w-2xl text-center">I am 
          <span className="text-cIndigo"> Ryzenen</span>. 
        I will always
        ...
        <div className="hidden lg:block absolute w-full bottom-20">
          {user?.username && (
            <div className="w-full flex justify-center items-center space-x-4">
              <img style={{ zIndex: 2 }} draggable={false} className={`transition-all ${slideAvatar ? 'translate-x-0' : 'translate-x-72'} duration-500 rounded-full flex-shrink-0`} width="172" height="72" src={`https://cdn.discordapp.com/avatars/852613869406912563/${user?.avatar}?size=4096`} />
              <p className={`${slideAvatar ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-72'} transition-all duration-500 break-words max-w-xl text-xl font-semibold`}>Hi, I am Ryzenen. I am a 3nd year high school student and I have been spending time with codes for about 3-4 years. I really dont know anything more about me. Thanks for reading.</p>
            </div>
          )}
        </div>
      </div>
